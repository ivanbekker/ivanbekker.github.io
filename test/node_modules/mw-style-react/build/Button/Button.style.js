...
exports.default = function (theme) {
  return {
    ...
    default: (0, _assign2.default)(theme.button.default.normal, {
      '&.disabled': {
    ...
    secondary: (0, _assign2.default)(theme.button.secondary.normal, {
      '&.disabled': {
    ...
    text: (0, _assign2.default)(theme.button.text.normal, {
      '&.disabled': {
